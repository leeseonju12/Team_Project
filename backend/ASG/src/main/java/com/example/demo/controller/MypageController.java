...
public class MypageController {
	...
	@ResponseBody
	public ResponseEntity<String> updateBusinessHours(@RequestBody List<Map<String, Object>> hours) {
		try {
	...
	@PostMapping("/address")
	@ResponseBody
	public ResponseEntity<String> updateAddress(@RequestParam String roadAddrPart1, @RequestParam String addrDetail) {
	...
	@GetMapping("/inquiry")
	@ResponseBody
	public ResponseEntity<List<com.example.demo.dto.myPage.InquiryResponse>> getInquiries(@RequestParam String email) {
	...
	@ResponseBody
	public ResponseEntity<List<com.example.demo.service.myPage.MypageService.ContentHistoryResponse>> getContentHistory() {
	    return ResponseEntity.ok(mypageService.getContentHistory());
	}
}
